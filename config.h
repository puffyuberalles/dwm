...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_cyan,  "#454545" },
...
static const Rule rules[] = {
	...
	{ "sam",      NULL,	  NULL,	      0,	    1,		 -1 },
	{ "acme",     NULL, 	  NULL,	      0,	    1,           -1 },
	{ "page",     NULL, 	  NULL,	      0,	    1,           -1 },
};
...
static const char *acme[] = { "/usr/lib/plan9/bin/acme", NULL };
static const char *sam[] = { "/usr/lib/plan9/bin/sam", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_e,           spawn,          {.v = acme } },
	{ MODKEY,                       XK_p,           spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_Return,  	spawn,          {.v = termcmd } },
	{ MODKEY, 			XK_s, 	   	spawn, 	   	{.v = webcmd } },
	{ MODKEY, 			XK_v, 		spawn, 		{.v = lockcmd } },
	{ MODKEY,			XK_m,		spawn,		{.v = sam } },
